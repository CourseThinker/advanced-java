...
* [mybatis-SQL执行过程](/docs/spring-frame/mybatis-sql.md)
...
- [Kafka高吞吐、低延时、高性能的实现原理?为什么kafka这么快?](/docs/high-concurrency/kafka_fast.md)
...
- [es 生产集群的部署架构是什么？每个索引的数据量大概有多少？每个索引大概有多少个分片？](https://mp.weixin.qq.com/s/mvLza4CT4S5S8mzPuMSydg)
...
- [分布式事务，两阶段提交协议，三阶段提交协议](/docs/distributed-system/2pc-3pc.md)
