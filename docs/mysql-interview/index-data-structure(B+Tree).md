...
![](/docs/mysql-interview/images/二叉树-1.bmp)  
...
**下面是平衡二叉树和非平衡二叉树的对比：**  
![](/docs/mysql-interview/images/二叉树-2.png)  
...
![](/docs/mysql-interview/images/二叉树-3.png)   
为了解决平衡二叉树的这个弊端，我们应该寻找一种单个节点可以存储多个键值和数据的平衡树。也就是我们接下来要说的 B 树。  
**B 树（Balance Tree）即为平衡树的意思，下图即是一棵 B 树：**  
![](/docs/mysql-interview/images/B树-1.png)   
...
![](/docs/mysql-interview/images/B树-2.png)  
...
**利用聚集索引查找数据**  
![](/docs/mysql-interview/images/B树-3.png)  
...
```
**下面看下具体的查找流程图：**  
![](/docs/mysql-interview/images/B树-4.png)   

**利用非聚集索引查找数据**  
![](/docs/mysql-interview/images/B树-5.png)   

读者看到这张图的时候可能会蒙，这是啥东西啊？怎么都是数字。如果有这种感觉，请仔细看下图中红字的解释。

什么？还看不懂？那我再来解释下吧。首先，这个非聚集索引表示的是用户幸运数字的索引（为什么是幸运数字？一时兴起想起来的:-)），  
此时表结构是这样的。  
![](/docs/mysql-interview/images/B树-6.png)  
...
引用：[终于有篇看的懂的 B 树文章了](https://mp.weixin.qq.com/s?__biz=MzU0OTk3ODQ3Ng==&mid=2247486613&idx=1&sn=da9de7105d0a4b57727c8f2da01a8ca1&chksm=fba6e496ccd16d80f8cae0591f995fa2b91832c70beee7d6b9d7cd1423cd3ed4f315d7c08e1d&scene=0&xtrack=1#rd)
